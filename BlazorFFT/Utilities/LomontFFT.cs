...
/* History:
 * Aug 2020 - v1.2 - uses Span<T> (andy updated this)
...
namespace Lomont
{
    ...
    public sealed class LomontFFT
    {
        ...
        public void FFT(Span<double> data, bool forward)
        {
            var n = data.Length;
            // checks n is a power of 2 in 2's complement format
            if ((n & (n - 1)) != 0) 
                throw new ArgumentException(
                    "length " + n + " in FFT is not a power of 2", nameof(data));
        ...
        /// <param name="forward">true for a forward transform, false for 
        /// inverse transform</param>
        public void TableFFT(Span<double> data, bool forward)
        {
            var n = data.Length;
            // checks n is a power of 2 in 2's complement format
            if ((n & (n - 1)) != 0) 
            ...
            var cosT = new ReadOnlySpan<double>(cosTable);
            var sinT = new ReadOnlySpan<double>(sinTable);
        ...
        /// <param name="forward">true for a forward transform, false for 
        /// inverse transform</param>
        public void RealFFT(Span<double> data, bool forward)
        {
        ...
        void Scale(Span<double> data, int n, bool forward)
        {
        ...
        void Initialize(int size)
        {
            ...
            var cosT = new Span<double>(cosTable = new double[size]);
            var sinT = new Span<double>(sinTable = new double[size]);
        ...
        /// <param name="data"></param>
        /// <param name="n"></param>
        static void Reverse(Span<double> data, int n)
        {
